...
class BioRxivSearchAdapter(ArticleSearchProvider):
    """Adapter for the bioRxiv feed exposed by api.biorxiv.org."""
    ...
    def __init__(
        ...
        *,
        ...
        user_agent: str = "BioRxivArticleSearch/1.0",
    ) -> None:
        ...
        *,
        ...
        for _ in range(max_pages):
            ...
            for entry in items:
                ...
                if max_items is not None and len(out) >= max_items:
                    break
                if max_items is None and len(out) >= int(page_size):
                    return out
